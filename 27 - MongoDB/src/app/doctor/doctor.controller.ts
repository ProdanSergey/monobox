...
doctors.post('/', withErrorHandler<Request<DoctorParams, unknown, DoctorCreateDTO>>(async (req, res) => {
...
doctors.get('/', withErrorHandler<Request<DoctorParams>>(async (req, res) => {
	const { facilityId } = req.params;
