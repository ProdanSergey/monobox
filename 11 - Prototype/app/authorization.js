...
const Authorization = (() => {
	...
	Authorization.prototype = {
		...
		signUp() {
			...
			account.password = STDIN.string(`Enter password: min length ${MIN_LENGTH} symbols`, (value) => value.length < MIN_LENGTH, true);
			...
			account.firstName = STDIN.string(`Enter your name pls, min length: ${MIN_NAME_LENGTH}, max length: ${MAX_NAME_LENGTH}`, nameValidator);
			...
			account.lastName = STDIN.string(`Enter your surname pls, min length: ${MIN_SURNAME_LENGTH}, max length: ${MAX_SURNAME_LENGTH}`, surnameValidator);
