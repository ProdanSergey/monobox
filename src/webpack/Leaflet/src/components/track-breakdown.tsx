...
import { StyledOrderIcon, StyledDeleteIcon, StyledItem, StyledList } from "./track-breakdown.styled";
...
export type TrackWaypointProps = PropsWithChildren<unknown>;

export const TrackWaypoint: FunctionComponent<TrackWaypointProps> = ({ children }) => {
  return (
    <StyledItem>
      <StyledOrderIcon>
        <MenuIcon testId={TRACK_WAYPOINT_TEST_ID} />
      </StyledOrderIcon>
      <span>{children}</span>
      <StyledDeleteIcon>
        <BucketIcon />
